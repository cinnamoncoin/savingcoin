...
int64 nChainStartTime = 1377740719;
...
const string strMessageMagic = "SavingCoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	// Subsidy is cut in half every 21,600 blocks, which will occur approximately every month
	nSubsidy >>= (nHeight / 21600); 
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in SavingCoin
    bool fStrictPayToScriptHash = true; // Always active in SavingCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SavingCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Aug 28, 2013: Asian shares stabilized on Thursday after two days of steep losses as fears abated that U.S.-led forces would soon launch a military strike on Syria, and oil prices retreated from a six-month peak.";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1377740779;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 11333311;
        ...
        assert(block.hashMerkleRoot == uint256("3f0c9f1864cc7aaf61b698c1fe44ba69a02edc346b43682812f58ca0feed9625"));
...
unsigned char pchMessageStart[4] = { 0xe4, 0xf2, 0xdb, 0xc0 };
